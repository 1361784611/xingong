...
var cubeRender, swipeRender, musicRender, zhufengpeixun;
document.addEventListener("touchmove", function (a) {
    a.preventDefault()
}, !1), cubeRender = function () {
    function d(a, b) {
        return Math.abs(a) > 30 || Math.abs(b) > 0
    }

    function e(a) {
        var b = a.touches[0];
        $(this).attr({strX: b.clientX, strY: b.clientY, changeX: 0, changeY: 0})
    }

    function f(a) {
        var b = a.touches[0], c = b.clientX - $(this).attr("strX"), d = b.clientY - $(this).attr("strY");
        $(this).attr({changeX: c, changeY: d})
    }

    function g() {
        var b = parseFloat($(this).attr("changeX")), c = parseFloat($(this).attr("changeY")), e = parseFloat($(this).attr("rotateX")), f = parseFloat($(this).attr("rotateY"));
        d(b, c) !== !1 && (e -= c / 3, f += b / 3, $(this).attr({
            rotateX: e,
            rotateY: f
        }).css("transform", "scale(0.6) rotateX(" + e + "deg) rotateY(" + f + "deg)"))
    }

    var a = null, b = null, c = null;
    return {
        init: function (d) {
            a = $("#" + d.cube), b = a.find("ul"), c = b.find("li"), a.css("display", "block"), b.attr({
                rotateX: -35,
                rotateY: 45
            }).on("touchstart", e).on("touchmove", f).on("touchend", g), d.swipe && c.tap(function () {
                var b = $(this).index();
                a.css("display", "none"), swipeRender.init(b, d)
            })
        }
    }
}(), swipeRender = function () {
    function e(a) {
        var d = a.slides, e = a.activeIndex;
        $.each(d, function (a, b) {
            return a === e ? (b.id = "page" + (e + 1), void 0) : (b.id = null, void 0)
        }), b && b.length > 0 && (e === c - 1 ? (b.makisu({
            selector: "dd",
            overlap: .6,
            speed: .8
        }), b.makisu("open")) : (b.makisu({selector: "dd", overlap: .6, speed: 0}), b.makisu("close")))
    }

    var a = null, b = null, c = 1, d = null;
    return {
        init: function (f, g) {
            a = $("#" + g.swipe), a.css("display", "block"), b = g.mak ? $("#" + g.mak) : null, c = b && b.length > 0 ? parseInt(b.attr("data-page")) : 1;
            var h = new Swiper(".swiper-container", {effect: "coverflow", onTransitionEnd: e, onInit: e});
            h.slideTo(f, 0), d = a.children(".return"), d.length > 0 && (null === g.cube ? d.css("display", "none") : null, g.cube && d.tap(function () {
                a.css("display", "none"), $("#" + g.cube).css("display", "block")
            }))
        }
    }
}(), musicRender = function () {
    var a = null, b = null;
    return {
        init: function (c) {
            a = $("#" + c), b = a.find("audio");
            var e = (a[0], b[0]);
            a.tap(function () {
                return e.paused ? (e.play(), a.addClass("move"), void 0) : (e.pause(), a.removeClass("move"), void 0)
            }), window.setTimeout(function () {
                e.play(), b.on("canplay", function () {
                    a.css("display", "block"), a.addClass("move")
                })
            }, 1e3)
        }
    }
}(), zhufengpeixun = function () {
    return {
        config: function (a) {
            var c, b = {cube: null, swipe: null, mak: null, music: null};
            for (c in a)a.hasOwnProperty(c) && (b[c] = a[c]);
            b.music && musicRender.init(b.music), b.cube && cubeRender.init(b), null === b.cube && b.swipe && swipeRender.init(0, b)
        }
    }
}();